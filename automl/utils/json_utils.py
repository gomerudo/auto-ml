...
from automl.config import ROOT_DIR
...
def _save_json_file(json_obj, json_name):
    path = ROOT_DIR+"/automl/createconfigspacepipeline/components/json_files_for_all_components/"+json_name+".json"
...
def read_json_file_to_json_obj(json_name):
    file_path = ROOT_DIR+"/automl/createconfigspacepipeline/components/json_files_for_all_components/"+json_name+".json"
...
def check_existence(json_name):
    dir_path = ROOT_DIR+"/automl/createconfigspacepipeline/components/json_files_for_all_components/"
