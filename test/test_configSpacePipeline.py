...
class TestConfigSpacePipeline(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.pipeline = Pipeline([('normalize', Normalizer(norm="max")),
                                 ('fastica', FastICA()),
        ...
        cls.component_json_xgbc = cls.config_space_pipeline_obj._get_component_json(component_name_xgbc)
        cls.component_dict_xgbc = cls.pipeline.steps[3][1].get_params()

        component_name_etc = 'ExtraTreesClassifier'
        cls.component_json_etc = cls.config_space_pipeline_obj._get_component_json(component_name_etc)
    ...
    def test_component_json_exist(self):
        ...
        self.assertEqual(self.config_space_pipeline_obj._component_json_exist(component_name_1), True)
        self.assertEqual(self.config_space_pipeline_obj._component_json_exist(component_name_2), False)

    def test_component_reset_default(self):
        self.assertIsInstance(self.config_space_pipeline_obj._component_reset_default(self.component_json_xgbc,
    ...
    def test_is_key_in_dic(self):
        ...
        self.assertTrue(self.config_space_pipeline_obj._is_key_in_dic(self.component_dict_xgbc, key_1))
        self.assertFalse(self.config_space_pipeline_obj._is_key_in_dic(self.component_dict_xgbc, key_2))
        self.assertIsInstance(self.config_space_pipeline_obj._is_key_in_dic(self.component_dict_xgbc, key_1), bool)

    def test_is_type_same(self):
        hyperparameter_value_1 = "dart"
        hyperparameter_value_2 = 2.435
        self.assertIsInstance(self.config_space_pipeline_obj._is_type_same(hyperparameter_value_1,
    ...
    def test_json_process_for_categorical(self):
        ...
        self.assertIsInstance(self.config_space_pipeline_obj._json_process_for_categorical(component_json_categorical,
    ...
    def test_json_process_for_int_and_float(self):
        ...
        self.assertIsInstance(self.config_space_pipeline_obj._json_process_for_int_and_float(component_json_int_float,
    ...
    def test_is_string_boolean(self):
        ...
        self.assertIsInstance(self.config_space_pipeline_obj._is_string_boolean(component_json_boolean,
    ...
    def test_is_string_none(self):
        ...
        self.assertIsInstance(self.config_space_pipeline_obj._is_string_boolean(component_json_none,
                                                                                component_dict_none),
                              bool)
